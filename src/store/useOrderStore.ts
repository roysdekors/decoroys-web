...
const demoOrders: Order[] = [
  {
    ...
    district: 'Kadıköy',
    items: [
      { id: 'decoroys-valens-tv-unitesi', name: 'Decoroys Valens TV Ünitesi', price: 9200, quantity: 1, image: '/zenna.png' },
    ],
    total: 9200,
    status: 'beklemede',
  ...
  },
  {
    ...
    district: 'Maltepe',
    items: [
      { id: 'decoroys-luna-tv-unitesi', name: 'Decoroys Luna TV Ünitesi', price: 11500, quantity: 1, image: '/zenna.png' },
      { id: 'decoroys-violet-tv-unitesi', name: 'Decoroys Violet TV Ünitesi', price: 8500, quantity: 2, image: '/zenna.png' },
    ],
    total: 28500,
    status: 'hazirlaniyor',
  ...
  },
  {
    ...
    district: 'Bornova',
    items: [
      { id: 'decoroys-horizon-tv-unitesi', name: 'Decoroys Horizon TV Ünitesi', price: 14500, quantity: 1, image: '/zenna.png' },
    ],
    total: 14500,
    status: 'kargoda',
  ...
  },
  {
    ...
    district: 'Çankaya',
    items: [
      { id: 'decoroys-crystal-tv-unitesi', name: 'Decoroys Crystal TV Ünitesi', price: 15800, quantity: 1, image: '/zenna.png' },
    ],
    total: 15800,
